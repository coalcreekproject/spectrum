(function() {
    ...
    angular
        .module("app.portal")
        .controller("UserPanelController", UserPanelCtrl);

    UserPanelCtrl.$inject = ["$scope", "$http", "$uibModal", "$state", "UserService"];

    function UserPanelCtrl($scope, $http, $uibModal, $state, UserService) {
