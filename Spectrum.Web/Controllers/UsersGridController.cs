...
namespace Spectrum.Web.Controllers
{
    ...
    public class UsersGridController : Controller
    {
        ...
        /// <summary>
        /// JSON Index method named lowercase to conform with javascript notation.  This was originally
        /// used for DataTables binding of user data. Moving to Angular instead so this is going away.
        /// Keeping fornow to seei fit proves useful at some point.
        /// </summary>
        /// <returns></returns>
        public JsonResult JsonIndex()
        {
            ...
            return Json(new
            {
               data = userViewModels.Select(u => new[] { u.Id.ToString(), u.UserName, u.Email, u.Password, u.ConfirmPassword })
