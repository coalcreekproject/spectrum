...
namespace Spectrum.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Datatables editor style and bootstrap integration
            bundles.Add(new StyleBundle("~/bundles/dataTablesEditor/css").Include(
                "~/Vendor/datatables_plugins/editor/dataTables.editor.min.css",
                "~/Vendor/datatables_plugins/editor/editor.bootstrap.min.css"));
            
            // Datatables editor
            bundles.Add(new ScriptBundle("~/bundles/dataTablesEditor/js").Include(
                "~/Vendor/datatables_plugins/editor/js/dataTables.editor.min.js",
                "~/Vendor/datatables_plugins/editor/js/editor.bootstrap.min.js"));

            // Table tools
            bundles.Add(new ScriptBundle("~/bundles/tableTools/js").Include(
                "~/Vendor/datatables_plugins/tabletools/dataTables.tableTools.js"));
