...
angular.module('app').directive('pageTitle', pageTitle).directive('sideNavigation', sideNavigation).directive('minimalizaMenu', minimalizaMenu).directive('sparkline', sparkline)
//.directive('icheck', icheck)
.directive('panelTools', panelTools).directive('smallHeader', smallHeader).directive('animatePanel', animatePanel).directive('landingScrollspy', landingScrollspy); /**
...
function panelTools($timeout) {
    return {
        restrict: 'A',
        scope: true,
        templateUrl: '/Templates/Common/panel_tools.html',
        controller: function controller($scope, $element) {
