...
(function () {
    ...
    angular.module("app.eoc").controller("IncidentMgmtCtrl", IncidentMgmtCtrl).config(config);
    ...
    function IncidentMgmtCtrl($scope, incidentData, $uibModal) {
        ...
        function editModal(incident) {
            var modalDialog = $uibModal.open({
                ...
                resolve: {
                    incidentModalData: function incidentModalData() {
                        return incident;
                    }
                }
            });
        ...
        function getIncidents() {
            $scope.loading = true;
            return incidentData.getIncidents().then(function (incidents) {
        ...
        function openModalInstance($scope, $uibModalInstance, incidentData) {
            ...
            $scope.saveChanges = function (incident) {
                ...
                // Add the incident
                incidentData.addIncident(incidentModel).then(function () {
        ...
        function editModalInstance($scope, $uibModalInstance, incidentModalData, incidentData) {
            ...
            $scope.saveChanges = function (incident) {
                // Edit the incident
                incidentData.editIncident(incident).then(function () {
                    $uibModalInstance.close();
                }, function (result) {
                    console.log(result.message);
                });
        ...
        function deleteModalInstance($scope, $uibModalInstance, incidentModalData) {
            ...
            $scope.delete = function (incidentId) {
                ...
                // Remove the incident
                incidentData.deleteIncident(incidentId).then(function () {
                    $uibModalInstance.close();
                }, function (result) {
                    console.log(result.message);
                });
