...
angular.module('app').controller('charts_flotCtrl', charts_flotCtrl);
...
function charts_flotCtrl($scope) {
     ...
     * Pie Chart Data
     */
    $scope.pieChartData = [{ label: "Data 1", data: 16, color: "#84c465" }, { label: "Data 2", data: 6, color: "#8dd76a" }, { label: "Data 3", data: 22, color: "#a2c98f" }, { label: "Data 4", data: 32, color: "#c7eeb4" }];

    $scope.pieChartDataDas = [{ label: "Data 1", data: 16, color: "#62cb31" }, { label: "Data 2", data: 6, color: "#A4E585" }, { label: "Data 3", data: 22, color: "#368410" }, { label: "Data 4", data: 32, color: "#8DE563" }];

    $scope.pieChartDataWid = [{ label: "Data 1", data: 16, color: "#fad57c" }, { label: "Data 2", data: 6, color: "#fde5ad" }, { label: "Data 3", data: 22, color: "#fcc43c" }, { label: "Data 4", data: 32, color: "#ffb606" }];
    ...
    $scope.sinCosChartData = [{ data: sin, label: "sin(x)" }, { data: cos, label: "cos(x)" }];
