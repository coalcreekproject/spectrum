...
function EditUserModalController($scope, $uibModalInstance, userFactory, user) {
    ...
    $scope.ok = function () {
        ...
        userFactory.editUser(user).then(function () {
            // success
        }, function () {
            // error
...
function userFactory($http, $q) {
    ...
    var _addUser = function _addUser(newUser) {
    ...
    var _editUser = function _editUser(user) {
    ...
    var _deleteUser = function _deleteUser(user) {
