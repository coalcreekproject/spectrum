...
(function () {
    ...
    angular.module("app.data").factory("currentUserFactory", currentUserFactory);
    ...
    function currentUserFactory($http, $q) {
        ...
        var _getCurrentUser = function _getCurrentUser() {

            var deferred = $q.defer();

            $http.get("/api/IdentityFocus/").then(function (result) {
                // Successful
        ...
        var _editCurrentUser = function _editCurrentUser(currentUser) {

            var deferred = $q.defer();

            $http.put("/api/IdentityFocus/", currentUser).then(function (result) {
                // success
