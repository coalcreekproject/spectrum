...
},'browser':function browser(){ /// <summary>Contains flags for the useragent, read from navigator.userAgent. We recommend against using this property; please try to use feature detection instead (see jQuery.support). jQuery.browser may be moved to a plugin in a future release of jQuery.</summary>
/// <returns type="PlainObject" />
},'browser.version':function browserVersion(){ /// <summary>The version number of the rendering engine for the user's browser.</summary>
/// <returns type="String" />
...
},'checked':function checked(){ /// <summary>Matches all elements that are checked.</summary>
...
},'selector':function selector(){ /// <summary>A selector representing selector originally passed to jQuery().</summary>
/// <returns type="String" />
