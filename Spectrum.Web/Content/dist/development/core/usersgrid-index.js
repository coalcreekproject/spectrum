...
function userGridController($scope, $http, $location, $uibModal, $state, uiGridConstants, userFactory) {
    ...
    $scope.usersGrid = {
        ...
        multiSelect: false,
        columnDefs: [{ field: 'Id', visible: false }, { field: 'UserName' }, { field: 'Email' }, { name: 'Options', cellTemplate: '<button class="btn btn-sm btn-default" ng-click="grid.appScope.edit(row)">Edit</button>' + '<button class="btn btn-sm btn-default" ng-click="grid.appScope.userprofiles(row)">Profiles</button>' + '<button class="btn btn-sm btn-default" ng-click="grid.appScope.roles(row)">Roles</button>' + '<button class="btn btn-sm btn-default" ng-click="grid.appScope.positions(row)">Positions</button>' + '<button class="btn btn-sm btn-default" ng-click="grid.appScope.delete(row)">Delete</button>'
        }],
